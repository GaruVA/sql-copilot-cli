...
namespace NL2SQL_CLI
{
    ...
    public class SqlQueryService
    {
        ...
        private string BuildConversationalPrompt(string naturalLanguageQuery)
        {
            ...
            sb.AppendLine();
            sb.AppendLine("T-SQL Syntax:"););
            sb.AppendLine("- Use dbo. prefix: dbo.Orders, dbo.Products");
            sb.AppendLine("- Dates: DATEADD(MONTH, -1, GETDATE()) NOT interval '1 month'");
            sb.AppendLine("- Limits: TOP 5 NOT LIMIT 5");
            sb.AppendLine("- Ordering: ORDER BY col DESC (no NULLS LAST)");
            sb.AppendLine("- No ILIKE, use LIKE instead");
            sb.AppendLine();
